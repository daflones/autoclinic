  ...
  return (
    <div className="space-y-6">
      <header className="flex flex-col gap-3 sm:gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-xl sm:text-2xl lg:text-3xl font-semibold tracking-tight text-foreground">Agendamentos Realizados</h1>
          <p className="text-xs sm:text-sm text-muted-foreground">
            Agendamentos concluídos com filtros avançados
          </p>
        </div>
        <Button size="sm" onClick={exportToCsv} disabled={agendamentosRealizados.length === 0} className="self-start sm:self-auto text-xs sm:text-sm">
